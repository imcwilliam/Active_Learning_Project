...
% \documentclass[msc,cogsci]{infthesis}
 \documentclass[msc,ai,leftchapter]{infthesis}  % for the MSc in Informatics
...
Hypothesis/objective, motivation and results achieved,

Surface level introduction to Active Learning, Curriculum Learning
\chapter{Background}
