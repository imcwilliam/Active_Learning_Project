...
In Table \ref{tab:HyperParams2} we lay out the other hyperparameters for the experiments.
...
\begin{subfigure}{0.7\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{GeoShapesDACResults_STE.png}
...
\hspace*{-1cm}   
  \centering
  \includegraphics[width=1\linewidth]{GeoShapesDACResults_Boxplt.png}
